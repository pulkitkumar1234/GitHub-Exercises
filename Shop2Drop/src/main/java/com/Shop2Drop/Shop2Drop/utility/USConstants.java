...
public class USConstants {
    ...
    public final static Map<String, String> mapOfUSCities = new HashMap<String, String>() {
        {
            put("AL", "Alabama");
            put("AK", "Alaska");
            put("AZ", "Arizona");
    ...
    public final static List<String> listOfUSCitiesCode = new ArrayList<>(mapOfUSCities.keySet());
    public final static List<String> listOfUSCitiesName = new ArrayList<>(mapOfUSCities.values());
